...
namespace Day01_NotQuiteLisp.Tests
{
    public class ElevatorLogicTest
    {
        ...
        [InlineData("))((((((", CharacterUp, CharacterDown, 4)]
        ...
        [Theory]
        [InlineData(")", CharacterUp, CharacterDown, 1)]
        [InlineData("()())", CharacterUp, CharacterDown, 5)]
        public void SolveTwoGivesExpectedOutput(string testInput, char characterUp, char characterDown, int expected)
        {
            // Arrange
            var elevatorLogic = new ElevatorLogic(testInput, characterUp, characterDown);

            // Act
            var result = elevatorLogic.SolveTwo();
